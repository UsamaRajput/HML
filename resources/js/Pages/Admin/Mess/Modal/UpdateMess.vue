<template>
    <!-- Modal -->
    <div class="modal fade" id="EDIT_MESS" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" data-bs-dismiss="modal" @click="updateMess">Update</button>
                </div>
...
eventBus.on('EDIT_MESS', function (data) {
    let myModal = new bootstrap.Modal(document.getElementById('EDIT_MESS'), {
        keyboard: false
    });
